...
<div class="bg-white">
    <header class="absolute inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="/pets" class="text-sm/6 font-semibold text-gray-900">All Pets</a>
                <a href="/admin" class="text-sm/6 font-semibold text-gray-900">Admin</a>
                <a href="/adopt/{post}" class="text-sm/6 font-semibold text-gray-900">Adopt</a>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                ...
                @auth
                        <a href="/logout" class="text-sm/6 font-semibold text-gray-900">Logout <span aria-hidden="true">&rarr;</span></a>
                @endauth
            </div>
        </nav>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8 mb-20">
