            ...
            <div className="flex-1 flex justify-center items-center px-5 lg:px-20 w-full">
                <MotionDiv className="hero-content flex-col w-full"
                    ...
                    <div className="text-center lg:text-left">
                        <h1 className="text-5xl text-indigo-900 font-bold">Login now!</h1>
                    </div>
                    <div className="card bg-indigo-50 w-full max-w-full shrink-0 shadow">
                        <div className="card-body">
                            <fieldset className="fieldset">
                                <label className="label font-bold">Email</label>
                                <input type="email" className="input focus:outline-none focus:ring-0 focus:border-indigo-900  w-full" placeholder="Email" />
                                <label className="label font-bold">Password</label>
                                <div className="relative w-full">
                                    <input
                                        type={showPassword ? "text" : "password"} className="input w-full focus:outline-none focus:ring-0 focus:border-indigo-900 pr-10"
                                ...
                                <div className="flex gap-5 my-2 mx-auto">
                                    ...
                                    <Link to='/register' className="link link-hover text-indigo-900">Register</Link>
                                </div>
                            </fieldset>
                        </div>
                    </div>
