import { FaPaw, FaMapMarkedAlt, FaFileAlt, FaHandsHelping } from "react-icons/fa";
    ...
    const services = [
        {
            ...
            title: "Pet Adoption",
            description: "Find and adopt your perfect companion from trusted shelters.",
        },
        {
            icon: <FaHandsHelping className="text-4xl text-amber-950" />,
            title: "Pet Rescue",
            description: "Report stray or injured animals and let us help them.",
        },
        {
            icon: <FaMapMarkedAlt className="text-4xl text-amber-950" />,
            title: "Nearby Map",
            description: "Locate shelters and clinics near you with our interactive map.",
        },
        {
            icon: <FaFileAlt className="text-4xl text-amber-950" />,
            title: "Adoption Tracking",
            description: "Apply online and track the status of your adoption journey.",
        },
    ];
