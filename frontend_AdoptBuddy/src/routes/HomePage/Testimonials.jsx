...
const TestimonialSection = () => {
    return (
        <section className="py-16 px-6 text-center">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">OUR CLIENT SAYING</h2>
            <p className="text-gray-500 max-w-xl mx-auto mb-8">
                about preventive care, wellness exams, and compassionate you and your pet.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                {testimonials.map((item) => (
                    ...
                    >
                        <div className="text-indigo-500 text-3xl mb-4 leading-none"><FaQuoteRight /></div>
