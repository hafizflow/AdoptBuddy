        ...
        <section ref={ref} className="px-6 py-16 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col-reverse md:flex-row items-center gap-10">
                ...
                <div className="md:w-1/2 space-y-6 text-center md:text-left">
                    <div>
                        <h3 className="text-xl font-semibold">WHY ADOPT CATS AND DOGS?</h3>
                        <p className="text-gray-500 mt-2 max-w-md mx-auto md:mx-0">
                            Every adoption gives a homeless pet a second chance at life. We ensure each pet is
                            healthy, vaccinated, and ready to join a loving home—because every animal deserves
